...
### React Native
    ...
    A Smaller version of the website as a native app, using the same ideation for authentication, redux integration and backend as our “frontend  website” –  Includes UI design and prototyping for the Native app.
